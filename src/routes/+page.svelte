		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
			{#each data.posts as post}
				<div class="card bg-base-200 shadow-xl">
					...
					<div
						class="card-body inline-flex animate-shine max-w-[350px] w-full items-center justify-center rounded-xl text-sm border border-white/10 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-4 py-5 transition-colors"
					>
						<div class="flex flex-col gap-2">
							<h3 class="text-xl font-semibold text-neutral-200 card-title">{post.title}</h3>
							<p class="text-sm leading-[1.5] text-neutral-400">
